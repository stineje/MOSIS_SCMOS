...
struct vint{
  ...
  volatile unsigned int fp1;
  volatile unsigned int fp2;
  volatile unsigned int fp3;
  volatile unsigned int fp4;
  volatile unsigned int fp5;
  volatile unsigned int fp6;
  volatile unsigned int fp7;
  volatile unsigned int fp8;
  volatile unsigned int fp9;
  volatile unsigned int fp10;
  volatile unsigned int fp11;
  volatile unsigned int fp12;
  volatile unsigned int fp13;
  volatile unsigned int fp14;
  volatile unsigned int fp15;
  volatile unsigned int fp16;
  volatile unsigned int fp17;
  volatile unsigned int fp18;
  volatile unsigned int fp19;
  volatile unsigned int fp20;
  volatile unsigned int fp21;
  volatile unsigned int fp22;
  volatile unsigned int fp23;
  volatile unsigned int fp24;
  volatile unsigned int fp25;
  volatile unsigned int fp26;
  volatile unsigned int fp27;
  volatile unsigned int fp28;
  volatile unsigned int fp29;
  volatile unsigned int fp30;
  volatile unsigned int fp31;
...
/* Amba Bus Base addresses */
#define CUSTOMBASE 0xA0160000
